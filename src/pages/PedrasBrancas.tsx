...
import {
  ...
  HardHat, Landmark, TrendingUp, LayoutGrid, Ruler, CalendarClock, Mountain
} from "lucide-react";
...
const differentials = [
  ...
  },
  {
    ...
    desc: "Localização estratégica com alto potencial de crescimento e valorização.",
  },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await submitToGoogleSheets({
        ...
        interesse: "Loteamento Pedras Brancas",
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-4 left-4 rounded-lg bg-primary px-5 py-3 shadow-lg flex items-center gap-2">
                ...
                <span className="text-xs text-primary-foreground font-medium">Natureza e tranquilidade</span>
              </div>
            </div>
          </div>
        </div>
