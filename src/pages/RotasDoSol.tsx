            ...
            {stats.map((stat, i) => {
              ...
              return (
                <RevealSection key={i} delay={i * 100} className="flex flex-col items-center justify-center py-8 gap-1">
                  {stat.value ? (
                    <span className="font-bold text-[#C8922A] text-3xl md:text-4xl font-['Playfair_Display']">
                      {stat.value}
                    </span>
                  ) : (
                    <Icon className="h-8 w-8 text-[#C8922A]" />
                  )}
                  <span className="text-xs uppercase tracking-widest text-white/60 font-medium font-['DM_Sans']">
                    {stat.label}
                  </span>
                </RevealSection>
              );
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <RevealSection>
              ...
              <p className="text-[#1B3A2D]/60 leading-relaxed mb-4 font-['DM_Sans']">
                Localizado na encantadora Barra do Itapocú, o Rotas do Sol oferece a harmonia perfeita entre a natureza
                preservada e o conforto da infraestrutura moderna.
              </p>
              <p className="text-[#1B3A2D]/60 leading-relaxed mb-6 font-['DM_Sans']">
                Um investimento seguro em uma das regiões que mais cresce em Santa Catarina, ideal para quem busca
                qualidade de vida ou uma excelente oportunidade de valorização imobiliária.
              </p>
      ...
      <section className="py-24 md:py-32 bg-[#1B3A2D]">
        <div className="container mx-auto px-4">
          <RevealSection className="text-center mb-14">
            ...
            <p className="text-white/60 max-w-xl mx-auto font-['DM_Sans']">
              Conheça o loteamento através de imagens e informações exclusivas.
            </p>
          </RevealSection>

          <RevealSection className="max-w-md mx-auto">
            <div
              className="relative w-full rounded-2xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] ring-1 ring-white/10"
              style={{ paddingBottom: "179.31%" }}
            >
              <video
              ...
              <RevealSection key={i} delay={i * 100}>
                <div className="group relative overflow-hidden rounded-2xl">
                  <img
                    src={item.img}
                    alt={item.alt}
                    className="w-full object-cover aspect-[16/11] group-hover:scale-105 transition-transform duration-500"
                  />
              ...
              return (
                <RevealSection key={i} delay={i * 80}>
                  <div className="group flex flex-col items-center justify-center py-6 px-3 text-center gap-3 rounded-2xl border border-[#1B3A2D]/10 hover:border-[#C8922A]/50 transition-all duration-300 hover:-translate-y-1 bg-white">
                    ...
                    <span className="text-xs font-semibold text-[#1B3A2D] uppercase tracking-wide font-['DM_Sans']">
                      {item.label}
                    </span>
                  </div>
                </RevealSection>
      ...
      <section className="py-24 md:py-32 bg-[#1B3A2D] border-t border-white/5">
        <div className="container mx-auto px-4 text-center">
          <RevealSection>
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-[#C8922A] hover:bg-[#b07e22] text-[#1B3A2D] font-bold px-10 py-4 rounded-full text-sm uppercase tracking-wider transition-colors font-['DM_Sans']"
            >
        ...
        <div className="container mx-auto px-4 text-center">
          <RevealSection>
            <img
              ...
              className="h-20 md:h-28 mx-auto brightness-0 invert opacity-60 mb-6"
            />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
            ...
            <RevealSection delay={200}>
              ...
              <h2 className="font-['Playfair_Display'] text-3xl md:text-4xl font-bold text-[#1B3A2D] mb-6">
                Onde Estamos
              </h2>
              <p className="text-[#1B3A2D]/60 leading-relaxed mb-8 font-['DM_Sans']">
                Localizado na Barra do Itapocú, Araquari – SC, com acesso direto pela BR-101 e próximo às principais
                cidades do litoral norte catarinense.
              </p>
              <div className="space-y-3 mb-8">
                {[
                  "Acesso direto pela BR-101",
                  "Próximo a Joinville e Jaraguá do Sul",
              ...
              <a
                href="https://maps.google.com/?q=Estr.+Geral+Barra+do+Itapocu,+Araquari,+SC"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#C8922A] hover:bg-[#b07e22] text-[#1B3A2D] font-bold px-6 py-3 rounded-full text-sm uppercase tracking-wider transition-colors font-['DM_Sans']"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start max-w-5xl mx-auto">
            <RevealSection>
              ...
              <p className="text-[#1B3A2D]/60 mb-8 leading-relaxed font-['DM_Sans']">
                Preencha o formulário e um de nossos consultores especializados entrará em contato para apresentar as
                melhores opções de lotes.
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-[#1B3A2D]/40 font-['DM_Sans']">
                      Telefone / WhatsApp
                    </p>
              ...
              <Button
                asChild
                className="bg-[#25D366] hover:bg-[#1fad54] text-white font-bold rounded-full px-8 font-['DM_Sans']"
              >
                <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-[#1B3A2D]/10 p-6 sm:p-8">
                {sent ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h3 className="text-xl font-bold text-[#1B3A2D] mb-2 font-['Playfair_Display']">
                      Mensagem Enviada!
                    </h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      <label className="text-xs font-semibold uppercase tracking-wider text-[#1B3A2D]/40 mb-1.5 block font-['DM_Sans']">
                        Nome Completo
                      </label>
                      <Input
                        required
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full font-bold uppercase tracking-wider bg-[#C8922A] hover:bg-[#b07e22] text-[#1B3A2D] rounded-full font-['DM_Sans']"
                      disabled={isSubmitting}
                    >
                      {isSubmitting ? "Enviando..." : "Enviar Solicitação"}
                    </Button>
                    <p className="text-center text-[10px] uppercase tracking-wider text-[#1B3A2D]/30 font-['DM_Sans']">
